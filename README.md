...
- Use more than 1 API
- Save data to localstorage or [firebase api](https://firebase.google.com/docs/database/web/start) with [React](https://css-tricks.com/intro-firebase-react/)
...
- Add User Sign Up, Sign In, and Sign Out with [Firebase and React Authentication](https://medium.com/firebase-developers/how-to-setup-firebase-authentication-with-react-in-5-minutes-maybe-10-bb8bb53e8834), alternative tutorial [here](https://css-tricks.com/firebase-react-part-2-user-authentication/) 
---
